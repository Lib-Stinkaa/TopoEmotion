...
class MultimodalLSTM(nn.Module):
    def __init__(self, n_signals=8, n_features_per_signal=518, num_classes=2):
        ...
        self.lstm = nn.LSTM(
            input_size=n_features_per_signal,
            hidden_size=128,
            num_layers=2,
            batch_first=True,
            dropout=0.3,
...
def main(features_file):
    ...
    print(f"LSTM - Valence: Acc={valence['accuracy_mean']:.4f}±{valence['accuracy_std']:.4f}, "
          f"F1={valence['f1_mean']:.4f}±{valence['f1_std']:.4f}")
    print(f"LSTM - Arousal: Acc={arousal['accuracy_mean']:.4f}±{arousal['accuracy_std']:.4f}, "
